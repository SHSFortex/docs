...
Das System injiziert Domain-Expertise (KRITIS, NIS-2, Krisenprozesse, Storytelling-Techniken) durch selektives Laden von Wissensbasen in den System Prompt. Mit Prompt Caching werden 90% der Kosten bei wiederholten Kombinationen eingespart.

**Hauptmerkmale**:
- Selective Loading (~71K Tokens typisch vs. ~203K für vollständigen Kontext)
- 420 mögliche Cache-Kombinationen basierend auf Regulatory Context + Sector + Incident
- Strukturierte Wissensbasis: regulatory/, protocols/, incidents/, storytelling/, examples/
- 90% Kosteneinsparung bei Cache Hits

### Scenario Persistence

MongoDB Atlas-basierte Persistierung ersetzt localStorage. Szenarien werden automatisch an Workflow-Meilensteinen gespeichert und sind geräte-/sitzungsübergreifend verfügbar.

**Hauptmerkmale**:
- Auto-Save an Meilensteinen (debounced 500ms)
- CRUD API mit PATCH für effiziente Partial Updates
- Szenario-Bibliothek mit List/Load/Resume
- Last-Write-Wins für Multi-User-Zugriff
- CrisisIQ Export-ID Tracking
...
- [Knowledge Augmentation](/internal/knowledge-augmentation) - Domain-Expertise-Injektion via Prompt Caching
- [Scenario Persistence](/internal/scenario-persistence) - MongoDB-basierte Persistierung und Workflow-Management
